    ...
    return (
        <>
            <div className="firstscreen-container">
                ...
                <Card Switch={true} Number="2." Title="Buy and sell products in real time!" Subtxt="Through live commerce, vendors can showcase their products more and get them sold to buyers in real time!" Pic={FSD2} />
